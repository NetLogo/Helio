...
export const patternBackgroundVariants = cva('relative text-clip', {
  variants: {
    variant: {
      ...
      [PATTERN_BACKGROUND_VARIANT.Dot]: 'bg-[radial-gradient(hsl(var(--foreground)/0.3)_1px,transparent_1px)]',
      [PATTERN_BACKGROUND_VARIANT.BigDot]: 'bg-[radial-gradient(hsl(var(--foreground)/0.3)_3px,transparent_3px)]',
    },
    size: {
      xs: 'bg-[size:8px_8px]',
