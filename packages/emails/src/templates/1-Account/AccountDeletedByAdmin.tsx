...
function AccountDeletedByAdminEmail({ branding, userName }: BasicProps) {
  return (
    <Layout
      branding={branding}
      preview={`Your ${branding.productName} account was deleted by an administrator.`}
    >
...
AccountDeletedByAdminEmail.PreviewProps = {
  branding: PREVIEW_BRANDING,
  userName: 'Jane',
} satisfies BasicProps;

export default AccountDeletedByAdminEmail;
