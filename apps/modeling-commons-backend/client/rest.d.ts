...
export interface paths {
    ...
    "/api/v1/models/{id}/comments/{commentId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/models/{id}/comments/{commentId}/like": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            parameters: {
                query?: {
                     ...
                     */
                    since?: string;
                    /** @description Only return notifications that have not been read yet */
                    unreadOnly?: boolean;
                };
                header?: never;
                path?: never;
                    ...
                    content: {
                        "application/json": {
                            ...
                            data: {
                                ...
                                id: string;
                                /** @enum {unknown} */
                                category: "comment.on_your_model" | "comment.reply_to_you" | "general.daily_digest";
                                title: string;
                                body: string;
                                /** Format: uri */
                                url: string;
...
export interface components {
    schemas: {
        ...
        "def-1": components["schemas"]["def-2"];
        /** Comment */
        "def-2": {
            /** Format: uuid */
            id: string;
