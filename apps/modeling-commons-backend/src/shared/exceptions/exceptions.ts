...
export class LimitExceededException extends ExceptionBase {
  static readonly message = 'Limit exceeded';
  readonly error = ExceptionError.BAD_REQUEST;
  constructor(message: string = LimitExceededException.message) {
    super(message);
  }
