...
const schema = Type.Object({
  ...
  STORE_ENDPOINT: Type.String(),
  STORE_PUBLIC_ENDPOINT: Type.Optional(Type.String()),
  STORE_DOCKER_ENDPOINT: Type.Optional(Type.String()),
  STORE_ACCESS_KEY: Type.String(),
  STORE_SECRET_KEY: Type.String(),
  STORE_REGION: Type.String(),
  STORE_BUCKET: Type.String(),
...
export default {
  ...
  storage: {
    ...
    publicEndpoint: env.STORE_PUBLIC_ENDPOINT ?? env.STORE_ENDPOINT,
    dockerEndpoint: env.STORE_DOCKER_ENDPOINT,
    accessKey: env.STORE_ACCESS_KEY,
    secretKey: env.STORE_SECRET_KEY,
    region: env.STORE_REGION,
    bucket: env.STORE_BUCKET,
    publicBaseUrl: `${env.STORE_PUBLIC_ENDPOINT ?? env.STORE_ENDPOINT}/${env.STORE_BUCKET}`,
  },
  galapagos: {
