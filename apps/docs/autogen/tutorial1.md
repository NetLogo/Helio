...
> - Open the Models Library from the File menu. ![[file-menu.webp]]
...
two arrows in the bottom right corners, like this: ![[tutorial1/goforeverinactive.webp]]

Once buttons don't have the arrows, like this: ![[tutorial1/setup.webp]]
...
Pressing an inactive button will have no effect. ![[tutorial1/goforeveractive.webp]]
...
you watch the progress of the model more closely.
...
at which turtles move, patches change color, and so on. ![[tutorial1/speed-slider.webp]]
...
Note that if you push the speed slider well to the right, the view may update so
...
> setting.
>
> - Change the "model-version" chooser from "sheep-wolves" to
>   "sheep-wolves-grass".
...
Changing the "model-version" dropdown to "sheep-wolves-grass" affected the
...
we were able to model all three factors: sheep, wolf, and grass populations.

Another type of setting is called a slider.

Besides choosers, a model may also have sliders. While choosers have a short
...
of the slider changes; this is the number the slider is currently set to.
...
> | wolves initially?
>
> - Change the "model-version" chooser from "sheep-wolves-grass" to
>   "sheep-wolves".
...
>
> Try running the model several times with these settings. | What happened to
> the sheep population?
>
> | Did this outcome surprise you? What other sliders can be | adjusted to help
...
One more type of widget is called a switch. A switch has only two values, on and
off.

> There is a switch in this model called "show-energy?"
>
> - Click "show-energy?" to check the box next to it and then click "setup" and
>   "go".
>
...
The plot in Wolf Sheep Predation contains three lines: sheep, wolves, and grass
...
what each line indicates. In this case, it's the population counts.
...
monitors in Wolf Sheep Predation: ![[tutorial1/monitors.webp]]
...
> ![[tutorial1/edit-view-properties.webp]] | What are the current settings for min-pxcor,
...
seen, because some are green, others brown.
...
that will help us locate objects within the room: ![[tutorial1/coords.webp]]
...
defined by top, bottom, left and right boundaries. ![[tutorial1/coords-horizontal.webp]]
![[tutorial1/coords-vertical.webp]]
...
information about HubNet, see the [HubNet Guide](https://docs.netlogo.org/hubnet).

## What's Next?

If you want to learn how to explore models at a deeper level,
[Tutorial #2: Commands](tutorial2) will introduce you to the NetLogo
modeling language.
