...
The simple script is easier to debug, while the general script is more convenient for repeated use. Both approaches are valid, and the scripts can also be found [here on GitHub](https://github.com/umit1010/slurm-scripts-for-netlogo).
...
The most up-to-date versions of these scripts, along with additional utilities and scripts, can be found [on BehaviorSpace HPC GitHub Repository](https://github.com/can-gurkan/BehaviorSpace-HPC).
