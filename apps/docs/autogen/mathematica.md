...
This section will very briefly introduce how to use the NetLogo-Mathematica
Link. It will show you how to load the NetLogo-Mathematica Link package, start
NetLogo, execute commands, and retrieve data from NetLogo.
...
where _your netlogo path_ is the directory that netlogo is located in. Typically
on a Mac this will be "/Applications/NetLogo {{version}}/"
...
> `NLLoadModel["/Applications/NetLogo {{version}}/models/Sample Models/Earth Science/Fire.nlogo"];`
...
> `NLCommand["set density 50"];` `myDensity = 60;`
...
To refer to this package in academic publications, please use: Bakshy, E.,
Wilensky, U. (2007). NetLogo-Mathematica Link.
http://ccl.northwestern.edu/netlogo/mathematica.html. Center for Connected
