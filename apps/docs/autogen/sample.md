...
>
> 1. Start NetLogo.
> 2. Choose "Models Library" from the File menu. ![[/file-menu.webp]]
...
"tolerance": ![[The tolerance slider|sample/tolerance.webp]]
...
| Can you see any other factors or variables that might affect the male to
female ratio within each group?
...
[Tutorial #1: Running Models](tutorial1) goes into more detail about how to
...
Eventually, you'll be ready for [Tutorial #3: Procedures](tutorial3). There
