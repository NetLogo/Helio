...
a procedure that doesn't exist, so the button turns red: ![[tutorial3/errors.webp]]
...
When you're done, the Code tab looks like this: ![[tutorial3/setupcode.webp]]
...
- `right random 360` is another command that uses a reporter. First, each turtle
  picks a random whole number between 0 and 359. ([[random]] doesn't include the
...
the [Topology](/programming#topology) section of the Programming Guide for
more information.)
...
![[tutorial3/scatter-on-green.webp]]
...
NetLogo primitive which looks like this: `hatch` _number_ [ *commands* ]. This
turtle creates _number_ new turtles, each identical to its parent, and asks the
new turtle(s) that have been hatched to run _commands_. You can use the commands
...
When you're done, the dialog should look like this: ![[tutorial3/totals.webp]]
...
when it runs out of room. ![[tutorial3/plotwindow.webp]]
...
[Programming Guide](/programming). All of the primitives are listed and
