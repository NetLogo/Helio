...
[Agentsets](programming.html#agentsets) for more information.
...
tab, as described in its [Plots Section](interfacetab.html#plots). However it is
...
See the [documentation](palette.html) of the palette extension for more
information.
...
The [Color Picker](colorpicker.html) dialog helps you experiment with and choose
...
[`vid:record-interface`](vid.html#vid:record-interface), depending on whether
