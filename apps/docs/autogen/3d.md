...
addition to [[pxcor|dictionary#pcor]] and [[pycor|dictionary#pcor]], patches have [[pzcor|3d#zcor]].

Turtles have three Cartesian coordinates, instead of two, to describe
position. In addition to [[xcor|dictionary#pcor]] and [[ycor|dictionary#pcor]], turtles have [[zcor|3d#zcor]].

A turtle's orientation is defined by three turtle variables,
[[heading]], [[pitch|3d#pitch]], and [[roll|3d#roll]].
...
[[load-shapes-3d|3d#load-shapes-3d]] to load shapes
