...
- Hovering over the edit dialog entry titles will show a helpful 'tooltip'.
...
so you don't have to revisit this page as often *(Since 6.4)*.
...
[Random Numbers](/programming#random-numbers) section of the Programming
Guide.
...
<blockquote>
<code>count frogs</code><br>
<code>count mice</code><br>
<code>count birds</code>
</blockquote>
...
size](/faq#how-big-can-my-model-be-how-many-turtles-patches-procedures-buttons-and-so-on-can-my-model-contain).
...
See the [Controlling](controlling) section of the User Manual for further
