...
tutorial. ([Tutorial #3](tutorial3.html) will go into greater detail about
...
>
> <p class="screenshot">
>   <img alt="screen shot" width="90%" src="images/tutorial2/export-view-brown-cars-on-yellow.png">
...
[NetLogo Programming Guide](programming.html).)
...
in the [Programming Guide](programming.html).)
...
colors are represented in NetLogo see the [Colors](programming.html#colors)
section of the NetLogo Programming Guide. The
[Color Picker Guide](colorpicker.html) explains how to choose colors using a
dialog.
...
> [pycor](dictionary.html#pcor) variable is 0. If we go back to the analogy of
