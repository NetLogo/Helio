...
[NetLogo Programming Guide](https://docs.netlogo.org/programming).)
...
in the [Programming Guide](https://docs.netlogo.org/programming).)
...
In [Tutorial #3: Procedures](tutorial-3) you can learn how to alter and
